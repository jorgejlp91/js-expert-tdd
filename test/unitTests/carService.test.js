...
describe('CarSerivece Suite Tests', () => {
    let carService = {}
    let sandbox = {}
    before(() => {
    ...
    it('should retrieve a random position from an array', ()=> {
        ...
        const result = carService.getRandomPosition(data)
    ...
    it('should choose the first id from carIds in carCategory', () => {
        ...
        expect(carService.getRandomPosition.calledOnce).to.be.ok
        expect(result).to.be.equal(expected)

    })
 
    it('given a carCategoy it should return an available car', async  () => {
